...
const mirim = document.querySelector("#mirim")
...
let randomPhrase = document.querySelector("#frase")
let generateRandomPhrase


//Eventos
mirim.addEventListener('click', generatePhrase)
//Quando clico na <img>, chamo a function (troca de tela e gera a frase)
